...
class CanvasComponent extends React.Component {
    ...
    drawArea(r, i, canvas) {
        ...
        let h = canvas.height;
        let w = canvas.width;
        ctx.strokeStyle = "#717369";
        ctx.fillStyle = "#717369";
        ctx.beginPath();
        ctx.moveTo(w / 2, h / 2);
        ctx.arc(w / 2, h / 2, r * i / 2, Math.PI, Math.PI * 1.5);
        ctx.moveTo(w / 2, h / 2);
