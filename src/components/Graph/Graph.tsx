...
const Graph = (props: any) => {
    ...
    function drawCanvas(canvas: any) {
        ...
        function drawShapes(r: number) {
            ...
            function drawCircle() {
                ...
                ctx.arc(xAxis, yAxis, gapBetweenNotchesX * r/2, Math.PI , Math.PI * 1.5);
                ctx.fill();
                ctx.closePath();
            }
            ...
            function drawRectangle() {
                ...
                ctx.fillRect(xAxis, yAxis, gapBetweenNotchesX * r , -gapBetweenNotchesY * r);
                ctx.stroke();
            }
    ...
    useEffect(() => {
        if(props.radius>0 && props.radius<=5){
